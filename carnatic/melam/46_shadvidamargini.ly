...
-----------------------------------------
	...
	section 2: Swara-stanas belonging to Ragam Shadvidamargini
...
(ga . , (ly:make-pitch -1 2 FLAT))
(ma . , (ly:make-pitch -1 3 SHARP))
(pa . , (ly:make-pitch -1 4 NATURAL))
(dha . , (ly:make-pitch -1 5 NATURAL))
(ni . , (ly:make-pitch -1 6 FLAT))

)

pitchnames = \pitchnamesShadvidamargini
